...
workflow CallVariantsWithHaplotypeCaller {
    meta {
        author: "Jonn Smith-->one got changed by S. Zaheri"
    ...
    command <<<
        ...
        gatk --java-options "-Xmx${java_memory_size_mb}m -Xms${java_memory_size_mb}m" \
            HaplotypeCaller \
                ...
                --emit-all-sites \ # SZ: Add --emit-all-sites to HaplotypeCaller_GATK4_VCF to explicitly include confident reference and non-variant sites.
