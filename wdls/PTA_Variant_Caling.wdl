...
import "Utility/VariantUtils.wdl" as VARUTIL
import "QC/FastQC.wdl" as FastQC
import "Utility/Finalize.wdl" as FF
import "QC/AlignedMetrics.wdl" as AM
import "VariantCalling/CallVariantsIllumina.wdl" as VAR
import "VariantCalling/HaplotypeCaller.wdl" as HC
import "QC/SampleLevelAlignedMetrics.wdl" as COV

workflow SRWholeGenome {

    meta {
        author: "Jonn Smith---> Slightly modified by S. Zaheri"
